...
define("core", [
	...
	function parse_parts(url) {
		...
		if (app.config.layout) chunks.unshift(app.config.layout);
	...
	var app = {
		...
		render: function(name) {
			name = name ? name : app.config.start;
